...
| `24 * 60 * 60`, `"a" + "b"`, `-x` where the operands are integers or strings written in the source | the value, `86400`, `"ab"`, as a hand-writer writes it; an integer past 2^53, which a double does not hold, stays an expression |
