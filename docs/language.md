...
| Source | Value | ASL result | CPython result |
|---|---|---|---|
| `str(datetime.now())`, `str(datetime.fromtimestamp(x))`, `str(dt + timedelta(...))` | any time | the time in UTC, such as `"2026-09-15T13:43:06.735Z"` | the local time, such as `"2026-09-15 22:43:06.735213"` |
